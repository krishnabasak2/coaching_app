                ...
                <div class="sidebar__menu-group">
                    <ul class="sidebar_nav">
                        ...
                        <li class="has-child">
                            ...
                            <ul>
                                <li class>
                                    <a href="{{ url('coaching/batch/create') }}">New Batch</a>
                                </li>
                                <li class>
                                    <a href="{{ url('coaching/batch/all') }}">All Batch</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="has-child">
                            ...
                            <ul>
                                <li class>
                                    <a href="{{ url('coaching/batch/all/trash') }}">Batch</a>
                                </li>
                            </ul>
                        </li>
